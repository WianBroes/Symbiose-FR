...
Relire les échanges entre la dernière occurrence de `[scan]` dans le contexte et le message courant. Si c'est le premier scan de la session, lire depuis le début de la session.
